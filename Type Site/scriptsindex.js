...
document.addEventListener('DOMContentLoaded', function() {
    ...
    highlightContainer.addEventListener('mouseenter', function() {
        popupBar.style.transform = 'translateY(-80px)';
    });

    highlightContainer.addEventListener('mouseleave', function() {
        popupBar.style.transform = 'translateY(100%)';
    });
});
